...
Lo schema separa sensori, ESP32-S3, VESC/CAN, potenza, safety fisica e logging. Il principio chiave e' che `STOP` ed `ESTOP` restano prioritari rispetto al follow-me e che la perdita di misura o comando porta sempre a comando motori nullo.

---

## 5. Checklist di Aggiornamento Disegni CAD (Modifiche Strutturali)
